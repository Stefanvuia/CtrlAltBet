...
public class BlackJackHitContinueTest {
    ...
    private BlackJackHitOutputBoundary cPresenter = new BlackJackHitOutputBoundary() {
        @Override
    ...
    void continueTest() {
        ...
        interactor.execute(new BlackJackInputGameData((BlackJackGameInterface) cGame));
    }
}
